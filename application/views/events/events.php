...
<div class="view_events">
    ...
    <input type="button" value="Add New Event" onclick="window.location='<?php echo base_url()?>start/newEvent'"/>
    </div>
    <br />
    <div class="event_left">
	<form action="<?php echo base_url() ?>start/searchEvent" method="post" >
        <div>Location</div>
