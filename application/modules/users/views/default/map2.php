...
$imagesFolderPath = 'http://localhost/iehop/images/';
$uploadDirectoryPath = 'http://localhost/iehop/uploads/';

$imagesFolderPath = 'http://medimegastore.com/gmap/iehop/images/';
$uploadDirectoryPath = 'http://medimegastore.com/gmap/iehop/uploads/';
...
<html>
  <head>
      ...
      function initialize() {
		...
		google.maps.event.addListener(autocomplete1, 'place_changed', function() {
			...
			var marker = new google.maps.Marker({
                ...
                icon:'<?php echo $imagesFolderPath.'7.png'; ?>'
            });
		});
		...
		google.maps.event.addListener(autocomplete2, 'place_changed', function() {
			...
			var marker = new google.maps.Marker({
                ...
                icon:'<?php echo $imagesFolderPath.'2.png'; ?>'
            });
		...
		google.maps.event.addListener(autocomplete3, 'place_changed', function() {
			...
			var marker = new google.maps.Marker({
                ...
                icon:'<?php echo $imagesFolderPath.'1.png'; ?>'
            });
		});
        ...
        google.maps.event.addListener(autocomplete4, 'place_changed', function() {
			...
			var marker = new google.maps.Marker({
                ...
                icon:'<?php echo $imagesFolderPath.'6.png'; ?>'
            });
		}); 
		...
		$.ajax({
			...
			success:function(data){
				...
				for(var i = 0; i < dataLength; i++){
					...
					var marker1IconPath = '<?php echo $imagesFolderPath.'7.png'; ?>';
					if(countVals == dataLength){
						marker1IconPath = '<?php echo $imagesFolderPath.'MyLocationMarker.png'; ?>';
					}
					marker1 = new google.maps.Marker({
						...
						image3:image3,
						video1:video1,
						icon: marker1IconPath//'<?php echo $imagesFolderPath.'7.png'; ?>'
					});
		...
		google.maps.event.addListener(marker, "click", function () { console.log(marker)
				var html =  '<div>';
					...
					if(type == 2 || type == 3){
						...
						if(marker.image1)
							html += '<img src="<?php echo $uploadDirectoryPath; ?>'+marker.image1+'" width="50px">';
						if(marker.image2)
							html += '<img src="<?php echo $uploadDirectoryPath; ?>'+marker.image2+'" width="50px">';
						if(marker.image3)
							html += '<img src="<?php echo $uploadDirectoryPath; ?>'+marker.image3+'" width="50px">';
						if(marker.video1)
							html += '<img src="<?php echo $imagesFolderPath; ?>video_default.png" width="50px">';
	...
	function display_gallery_form(markerDbId){
		var iframe = '<img src="<?php echo $imagesFolderPath; ?>close.png" width="20px" align="right" style="cursor:pointer;" onclick="close_iframe_window()">';
		iframe += '<iframe src="<?php echo base_url().'map/view_iframe_form?fieldId=';?>'+markerDbId+'" name="" width="100%" height="100%" frameborder="0" >';
  ...
  <body>
	...
	<div id="left_panel" style="float:left;">
		...
		<table cellspacing="5" cellpadding="5" align="center">
			<tr>
				<td><img src="<?php echo $imagesFolderPath.'7.png'; ?>" align="top" width="15">&nbsp;My Location</td>
				<td>
			...
			<tr>
				<td><img src="<?php echo $imagesFolderPath.'2.png'; ?>" align="top" width="15">&nbsp;Places I have eHopped to</td>
				<td>
			...
			<tr>
				<td><img src="<?php echo $imagesFolderPath.'1.png'; ?>" align="top" width="15">&nbsp;Places I have visited</td>
				<td>
			...
			<tr>
				<td><img src="<?php echo $imagesFolderPath.'6.png'; ?>" align="top" width="15">&nbsp;Places I would like to visit</td>
				<td>
