<html>
<head>
<link href='<?php echo base_url()?>public/fullcalendar.css' rel='stylesheet' />
<link href='<?php echo base_url()?>public/fullcalendar.print.css' rel='stylesheet' media='print' />
<link href='<?php echo base_url()?>public/css/custom.css' rel='stylesheet' />
<script src='<?php echo base_url()?>public/moment.min.js'></script>
<script src='<?php echo base_url()?>public/jquery.min.js'></script>
<script src='<?php echo base_url()?>public/fullcalendar.min.js'></script>
<script>
...
<div class="view_events">
	...
	<div class="event_list">
        ...
        <ul>
	       <?php for($i=0; $i<count($events); $i++){
	           echo "<li>".$events[$i]->event_name."</li>";
	       }?> 
       </ul>
	</div>
</div>
