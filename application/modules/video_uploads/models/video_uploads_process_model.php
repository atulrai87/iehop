...
if (!defined('VIDEOS_PROCESS_TABLE')) define('VIDEOS_PROCESS_TABLE', DB_PREFIX.'videos_process');
...
//		$check_process = $this->get_process_by_status('processing');
//		if(!empty($check_process)) return;
