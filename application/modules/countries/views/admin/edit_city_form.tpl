...
<form method="post" action="{$data.action}" name="save_form" enctype="multipart/form-data">
	<div class="edit-form n150">
		<div class="row header">
			{if $data.id}
				{l i='admin_header_city_change' gid='countries'}
			{else}
				{l i='admin_header_city_add' gid='countries'}
			{/if}
		</div>
		<div class="row">
		...
		<div class="row">
			<div class="h">{l i='field_region' gid='countries'}: </div>
			<div class="v">{$region.name}</div>
		</div>
		<div class="row">
			<div class="h">{l i='field_city_name' gid='countries'}: </div>
			<div class="v">
		...
		<div class="row">
			<div class="h">{l i='field_latitude_name' gid='countries'}: </div>
			<div class="v"><input type="text" value="{$data.latitude}" name="latitude"></div>
		</div>
		<div class="row">
			<div class="h">{l i='field_longitude_name' gid='countries'}: </div>
			<div class="v"><input type="text" value="{$data.longitude}" name="longitude"></div>
		</div>
	</div>
	<div class="btn">
		<div class="l">
	...
	<a class="cancel" href="{$site_url}admin/countries/region/{$country.code}/{$region.id}">{l i='btn_cancel' gid='start'}</a>
</form>
<div class="clr"></div>
<script>{literal}
	$(function() {
