...
<form method="post" action="{$data.action}" name="save_form" enctype="multipart/form-data">
	<div class="edit-form n150">
		<div class="row header">
			{if $data.id}
				{l i='admin_header_countries_change' gid='countries'}
			{else}
				{l i='admin_header_countries_add' gid='countries'}
			{/if}
		</div>
		<div class="row">
			<div class="h">{l i='field_country_code' gid='countries'}: </div>
			<div class="v"><input type="text" value="{$data.code}" name="code" class="short"></div>
		</div>
		<div class="row">
			<div class="h">{l i='field_country_name' gid='countries'}: </div>
			<div class="v">
	...
	<a class="cancel" href="{$site_url}admin/countries">{l i='btn_cancel' gid='start'}</a>
</form>
<div class="clr"></div>
<script>{literal}
$(function(){
