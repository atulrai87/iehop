{if !$geomap_js_loaded && !$only_load_content}
	<link href="{$site_root}application/modules/geomap/views/default/css/yandexv2.css" rel="stylesheet" type="text/css" />
	<script>{literal}
		$(function() {
			loadScripts(
				[
...
{if !$only_load_scripts}
	...
	<script>{literal}
		...
		map_loader = function(){
			...
			if(settings.use_tools) map_properties.use_tools = true;
			if(settings.use_clusterer) map_properties.use_clusterer = true;
			if(settings.use_click_zoom) map_properties.use_click_zoom = true;
