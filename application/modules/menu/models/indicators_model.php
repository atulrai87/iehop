...
* @version $Revision: 1 $ $Date: 2013-07-16 16:16:07 +0300 (Вт, 16 июл 2013) $ $Author: abatukhtin $
**/

if (!defined('INDICATORS_TABLE')) define('INDICATORS_TABLE', DB_PREFIX . 'menu_indicators');
if (!defined('INDICATORS_TYPES_TABLE')) define('INDICATORS_TYPES_TABLE', DB_PREFIX . 'menu_indicators_types');
...
class Indicators_model extends Model
{
	...
	private $_auth_types = array('user', 'admin', 'mudule');
	...
	public function save_type($gid = null, $data = array()) {
		if(empty($data)) {
			...
			return $this;
		}elseif(!empty($data['auth_type']) && !in_array($data['auth_type'], $this->_auth_types)) {
