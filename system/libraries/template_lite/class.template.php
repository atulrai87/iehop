...
class Template_Lite {
	...
	public $_cache_salt    = 'jyyurlj}rxw8rn€|8jmvrw8rvp8|vrun|7pro';
	...
	function _fetch_compile($file)
	{
		...
		if($this->_resource_type == "file")
		{
			...
			if ($size > 0)
			{
				...
				{
					$str_find = base64_decode('JmNvcHk7Jm5ic3A7MjAwMC0yMDE0Jm5ic3A7PGEgaHJlZj0iaHR0cDovL3d3dy5waWxvdGdyb3VwLm5ldCI+UGlsb3RHcm91cC5ORVQ8L2E+IFBvd2VyZWQgYnkgPGEgaHJlZj0iaHR0cDovL3d3dy5kYXRpbmdwcm8uY29tLyI+UEcgRGF0aW5nIFBybzwvYT4=');
