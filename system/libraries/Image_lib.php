...
class CI_Image_lib {
	...
	{	
		...
		if (isset($this->background) && $this->background)
		{
			...
			$dst_img = $this->image_background_gd($dst_img, $this->bgwidth, $this->bgheight, $this->bgcolor);
		}
	...
	function image_grayscale_gd($src_img, $width, $height){
	...
	function image_background_gd($src_img, $width, $height, $color_array=array('red'=>255, 'green'=>255, 'blue'=>255)){
