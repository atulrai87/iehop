<?php /* V2.10 Template Lite 4 January 2007  (c) 2005-2007 Mark Dickenson. All rights reserved. Released LGPL. 2014-09-11 20:23:10 CDT */ ?>
...
<script>
    $(document).ready(function() {
		...
		$(\'#calendar\').fullCalendar({
			...
			events: [
				';  if (is_array($this->_vars['events']) and count((array)$this->_vars['events'])): foreach ((array)$this->_vars['events'] as $this->_vars['key'] => $this->_vars['item']):  echo '
				{
					title: "';  echo $this->_vars['item']->event_name;  echo '",
					start: "';  echo $this->_vars['item']->start_date;  echo '",
					end: "';  echo $this->_vars['item']->end_date;  echo '",
				},
...
<div class="view_events">
	...
	<div class="event_list">
        Event List<br/>
        <ul>
		<?php if (is_array($this->_vars['events']) and count((array)$this->_vars['events'])): foreach ((array)$this->_vars['events'] as $this->_vars['key'] => $this->_vars['item']): ?>
		<li><?php echo $this->_vars['item']->event_name; ?>
</li>
