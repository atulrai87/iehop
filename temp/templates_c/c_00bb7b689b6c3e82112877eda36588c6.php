<?php require_once('C:\xampp\htdocs\iehop\system\libraries\template_lite\plugins\function.helper.php'); $this->register_function("helper", "tpl_function_helper");  require_once('C:\xampp\htdocs\iehop\system\libraries\template_lite\plugins\compiler.l.php'); $this->register_compiler("l", "tpl_compiler_l");  /* V2.10 Template Lite 4 January 2007  (c) 2005-2007 Mark Dickenson. All rights reserved. Released LGPL. 2014-09-16 23:10:40 India Standard Time */ ?>
...
users/restore"><?php echo l('link_restore', 'users', '', 'text', array()); ?></a></span>
			...
			<div class="r">
				<div class="f"><input type="checkbox" name="business" class="openid"> Login as Business<?php echo l('link_business', 'users', '', 'text', array()); ?></div>
			</div>
