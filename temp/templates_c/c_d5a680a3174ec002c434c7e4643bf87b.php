<?php require_once('/home/iehop/public_html/system/libraries/template_lite/plugins/compiler.l.php'); $this->register_compiler("l", "tpl_compiler_l");  /* V2.10 Template Lite 4 January 2007  (c) 2005-2007 Mark Dickenson. All rights reserved. Released LGPL. 2014-09-02 02:22:02 CDT */ ?>
	...
	<div class="edit-form n150">
		<div class="row header">
			<?php if ($this->_vars['data']['id']): ?>
				<?php echo l('admin_header_countries_change', 'countries', '', 'text', array()); ?>
			<?php else: ?>
				<?php echo l('admin_header_countries_add', 'countries', '', 'text', array()); ?>
			<?php endif; ?>
		</div>
		<div class="row">
			<div class="h"><?php echo l('field_country_code', 'countries', '', 'text', array()); ?>: </div>
			<div class="v"><input type="text" value="<?php echo $this->_vars['data']['code']; ?>
" name="code" class="short"></div>
		</div>
		<div class="row">
			<div class="h"><?php echo l('field_country_name', 'countries', '', 'text', array()); ?>: </div>
			<div class="v">
...
admin/countries"><?php echo l('btn_cancel', 'start', '', 'text', array()); ?></a>
</form>
<div class="clr"></div>
<script><?php echo '
$(function(){
