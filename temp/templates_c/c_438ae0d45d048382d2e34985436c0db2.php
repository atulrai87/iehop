<?php /* V2.10 Template Lite 4 January 2007  (c) 2005-2007 Mark Dickenson. All rights reserved. Released LGPL. 2014-09-09 11:29:02 CDT */ ?>
...
<link rel="stylesheet" type="text/css" media="all" href="<?php echo base_url()?>application/js/event_calendar/jsdatepick-calendar/jsDatePick_ltr.min.css" />
<script type="text/javascript" src="<?php echo base_url()?>application/js/event_calendar/jsdatepick-calendar/jsDatePick.min.1.3.js"></script>
<?php echo '
<script>
...
'; ?>
    ...
    <center>
    <form class="new_event_form" action="<?php echo base_url()?>start/saveEvent" method="post"><table>
        ...
        <tr><td>Where</td><td><input type="text" name="place" id="where" /></td><td id="where_error" class="error" ></td></tr>
