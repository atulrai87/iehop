<?php require_once('C:\xampp\htdocs\iehop\system\libraries\template_lite\plugins\function.breadcrumbs.php'); $this->register_function("breadcrumbs", "tpl_function_breadcrumbs");  require_once('C:\xampp\htdocs\iehop\system\libraries\template_lite\plugins\function.start_search_form.php'); $this->register_function("start_search_form", "tpl_function_start_search_form");  require_once('C:\xampp\htdocs\iehop\system\libraries\template_lite\plugins\function.menu.php'); $this->register_function("menu", "tpl_function_menu");  require_once('C:\xampp\htdocs\iehop\system\libraries\template_lite\plugins\function.block.php'); $this->register_function("block", "tpl_function_block");  require_once('C:\xampp\htdocs\iehop\system\libraries\template_lite\plugins\function.json_encode.php'); $this->register_function("json_encode", "tpl_function_json_encode");  require_once('C:\xampp\htdocs\iehop\system\libraries\template_lite\plugins\function.seotag.php'); $this->register_function("seotag", "tpl_function_seotag");  require_once('C:\xampp\htdocs\iehop\system\libraries\template_lite\plugins\block.strip.php'); $this->register_block("strip", "tpl_block_strip");  /* V2.10 Template Lite 4 January 2007  (c) 2005-2007 Mark Dickenson. All rights reserved. Released LGPL. 2014-09-16 23:10:40 India Standard Time */ ?>
