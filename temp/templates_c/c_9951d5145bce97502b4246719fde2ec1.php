<?php /* V2.10 Template Lite 4 January 2007  (c) 2005-2007 Mark Dickenson. All rights reserved. Released LGPL. 2014-09-16 20:52:54 India Standard Time */ ?>
...
#right_panel{
    ...
    <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?v=3.exp&sensor=false&libraries=places"></script>
		...
		var base_url = \'';  echo $this->_vars['site_url'];  echo '\';
      var map, infowindow;
      var geocoder;
      var bounds;
      var markersArr = [];
	...
	function add_locations_data(){
		console.log(base_url+\'map/add_details_new_location\');
...
//		});
	...
	<div id="left_panel" style="float:left;">
		...
		<table cellspacing="5" cellpadding="5" align="center">
			<tr>
				<td><img src="<?php echo $this->_vars['site_url']; ?>
images/7.png" align="top" width="15">&nbsp;My Location</td>
				<td>
			...
			<tr>
				<td><img src="<?php echo $this->_vars['site_url']; ?>
images/2.png" align="top" width="15">&nbsp;Places I have eHopped to</td>
				<td>
			...
			<tr>
				<td><img src="<?php echo $this->_vars['site_url']; ?>
images/1.png" align="top" width="15">&nbsp;Places I have visited</td>
				<td>
			...
			<tr>
				<td><img src="<?php echo $this->_vars['site_url']; ?>
images/6.png" align="top" width="15">&nbsp;Places I would like to visit</td>
				<td>
